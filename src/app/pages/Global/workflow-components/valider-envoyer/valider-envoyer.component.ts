...
@Component({
  selector: 'app-valider-envoyer',
  templateUrl: './valider-envoyer.component.html',
  styleUrls: ['./valider-envoyer.component.scss']
})
export class ValiderEnvoyerComponent implements OnInit {
  ...
  @Input() decisions: any[] = [];
  @Input() valider: boolean; // Define the valider property
  ...
  constructor(public location: Location, private toastr: ToastrService, private env: EnvService, private translateService: TranslateService,
