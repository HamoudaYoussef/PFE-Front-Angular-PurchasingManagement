...
@Component({
  selector: 'app-demande-achat-rejetee',
  templateUrl: './demande-achat-rejetee.component.html',
  styleUrls: ['./demande-achat-rejetee.component.scss']
})
export class DemandeAchatRejeteeComponent implements OnInit {
  ...
  getValidDemandes() {
    ...
    this.dataSourceElement = new CustomStore({
          ...
          load: function (loadOptions: any) {
            ...
            return this.httpClient.get(this.env.urlProject + 'demande-achats/demandes/rejetee?' + params, {headers: new HttpHeaders().set("Authorization", this.tokenStorage.getToken()).append("application", require('package.json').name)})
                .toPromise()
                .then((data: any) => {
